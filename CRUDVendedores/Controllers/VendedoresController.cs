...
using CRUDVendedores.Models;

namespace CRUDVendedores.Controllers
{
    public class VendedoresController : Controller
    {
        private readonly VendedoresMvcContext _context;

        public VendedoresController(VendedoresMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vendedores != null ? 
                          ...
                          Problem("Entity set 'VendedoresMvcContext.Vendedores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,PorcentajeComision,Estado")] Vendedore vendedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,PorcentajeComision,Estado")] Vendedore vendedore)
        {
            if (id != vendedore.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VendedoresMvcContext.Vendedores'  is null.");
            }
            var vendedore = await _context.Vendedores.FindAsync(id);
            if (vendedore != null)
            {
